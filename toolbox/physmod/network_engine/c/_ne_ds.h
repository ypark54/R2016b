...
NeParameterData; typedef enum NeDsIoTypeTag { UNKNOWN_IO_TYPE = -1,
NE_INPUT_IO_TYPE, NE_OUTPUT_IO_TYPE, NUM_IO_TYPES } NeDsIoType; typedef struct
NeDsIoInfoTag { const char *mName; size_t mM; size_t mN; const char *mUnit; const
char *mIdentifier; } NeDsIoInfo; PMF_DEPLOY_STATIC size_t
ne_get_num_io_signals(const NeDsIoInfo * io_info_ptr, size_t io_info_size) {
...
PmRealVector mDXICR; PmSparsityPattern mDXICR_P; PmSparsityPattern mTDUICR_P;
...
PmRealVector mSFO; PmRealVector mSFP; PmRealVector mINIT_R; PmIntVector mINIT_I;
PmRealVector mLOG; PmIntVector mASSERT; PmIntVector mPASSERT; PmRealVector
mDEL_T; PmRealVector mDEL_V; PmRealVector mDEL_V0; PmRealVector mDEL_TMAX;
PmSparsityPattern mDXDELT_P; PmRealVector mDXDELT; PmSparsityPattern mDUDELT_P;
PmRealVector mDUDELT; PmSparsityPattern mDTDELT_P; PmRealVector mDTDELT;
PmRealVector mOBS_EXP; PmRealVector mOBS_ACT; PmRealVector mOBS_ALL; PmIntVector
mDP_L; PmIntVector mDP_I; PmIntVector mDP_J; PmRealVector mDP_R; PmRealVector
mQX; PmRealVector mQU; PmRealVector mQT; PmRealVector mQ1; PmSparsityPattern
mQX_P; PmSparsityPattern mQU_P; PmSparsityPattern mQT_P; PmSparsityPattern mQ1_P;
PmRealVector mVAR_TOL; PmRealVector mEQ_TOL; } NeDsMethodOutput; typedef enum
...
NE_DS_METHOD_A, NE_DS_METHOD_B_P, NE_DS_METHOD_B, NE_DS_METHOD_C_P,
NE_DS_METHOD_C, NE_DS_METHOD_F, NE_DS_METHOD_VMF, NE_DS_METHOD_SLF,
...
NE_DS_METHOD_TDUF_P, NE_DS_METHOD_TDXF_P, NE_DS_METHOD_IC, NE_DS_METHOD_ICR,
...
NE_DS_METHOD_CACHE_R, NE_DS_METHOD_CACHE_I, NE_DS_METHOD_UPDATE_R,
NE_DS_METHOD_UPDATE_I, NE_DS_METHOD_SFO, NE_DS_METHOD_SFP, NE_DS_METHOD_INIT_R,
NE_DS_METHOD_INIT_I, NE_DS_METHOD_LOG, NE_DS_METHOD_ASSERT, NE_DS_METHOD_PASSERT,
...
NE_DS_METHOD_OBS_ALL, NE_DS_METHOD_DP_L, NE_DS_METHOD_DP_I, NE_DS_METHOD_DP_J,
...
NE_DS_METHOD_Q1_P, NE_DS_METHOD_VAR_TOL, NE_DS_METHOD_EQ_TOL, NE_NUM_METHODS }
...
mNumDiscreteRealVariables; size_t mNumDifferentialVariables; size_t
mNumEquations; size_t mNumICResiduals; size_t mNumModes; size_t mNumMajorModes;
size_t mNumRealCache; size_t mNumIntCache; size_t mNumObservables; size_t
