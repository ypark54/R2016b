...
LIBMWSF_RUNTIME_API void sfcs_request_service(SimStruct* S, const char* fcnName, int numInputs, void* inArgs, void* inSizes, int numOutputs, void* outArgs, int* outSizes);
LIBMWSF_RUNTIME_API void* sfcs_get_input_arg_from_exec_info(_ssFcnCallExecArgs* args, int i);
LIBMWSF_RUNTIME_API void* sfcs_get_output_arg_from_exec_info(_ssFcnCallExecArgs* args, int i);
...
LIBMWSF_RUNTIME_API void sf_check_msg_queue_for_overflow(SimStruct* S, int queueType, int queueId, int isSender,
