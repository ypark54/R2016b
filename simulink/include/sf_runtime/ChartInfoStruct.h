...
LIBMWSF_RUNTIME_API void sf_init_ChartRunTimeInfo(SimStruct* S, void * instanceInfo, bool isJITEnabled, bool isEnhancedMooreMachine);
...
LIBMWSF_RUNTIME_API bool sf_get_isEnhancedMooreMachine(SimStruct* S);
