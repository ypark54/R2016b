...
LIBMWSF_RUNTIME_API void sf_mex_check_struct_vs(const struct emlrtMsgIdentifier* aMsgId, const mxArray* aSrcMx, int32_T aNFields, const char** aFldNames,
                                                ...
                                                const void* aDimsMax,  
                                                void* aDimsActual);    
LIBMWSF_RUNTIME_API void sf_mex_check_bus_parameter(const mxArray* mxStruct, int32_T nFields, const char** fieldNames, const char* structName);
...
LIBMWSF_RUNTIME_API const mxArray* sf_mex_getcell(const char* aName, const mxArray* array, int index);
...
LIBMWSF_RUNTIME_API SfDataType sf_mex_get_sf_datatype_from_mx_datatype(mxClassID aDataType);
...
LIBMWSF_RUNTIME_API void ssReadFromDataStore_wrapper(SimStruct* S, int dsmIndex, void* dataAddr);
LIBMWSF_RUNTIME_API void ssReadFromDataStoreElement_wrapper(SimStruct* S, int dsmIndex, void* dataAddr, int elementIndex);
LIBMWSF_RUNTIME_API void ssWriteToDataStore_wrapper(SimStruct* S, int dsmIndex, void* dataAddr);
LIBMWSF_RUNTIME_API void ssWriteToDataStoreElement_wrapper(SimStruct* S, int dsmIndex, void* dataAddr, int ElementIndex);
...
LIBMWSF_RUNTIME_API int_T     ssGetNumMessagesInQueue_wrapper(SimStruct* S, ssMessageQueueLocationType qType, int queueID);
LIBMWSF_RUNTIME_API int_T     ssGetNumMessagesInOutputQueue_wrapper(SimStruct* S, int portIdx);
LIBMWSF_RUNTIME_API void*     ssMessageQueuePeekPayload_wrapper(SimStruct* S, ssMessageQueueLocationType qType, int queueID);
LIBMWSF_RUNTIME_API void*     ssMessageQueuePeekPayloadAtIndex_wrapper(SimStruct* S, ssMessageQueueLocationType qType, int queueID, int payloadIndex);
...
LIBMWSF_RUNTIME_API ssMessage ssMessageQueuePop_wrapper(SimStruct* S, ssMessageQueueLocationType qType, int queueID);
...
LIBMWSF_RUNTIME_API void      ssMessageRelay_wrapper(SimStruct* S, ssMessageQueueLocationType queueType, int pIdx, ssMessage msgObj);
LIBMWSF_RUNTIME_API bool      ssIsMessageQueueFull_wrapper(SimStruct *S, ssMessageQueueLocationType queueType, int portIdx, int isOutputPort);
...
LIBMWSF_RUNTIME_API void  sf_call_action_subsys_zero_crossing(SimStruct* S, void* execBlockPtr);
LIBMWSF_RUNTIME_API void  sf_call_action_subsys_enableCStates(SimStruct* S, void* execBlockPtr);
LIBMWSF_RUNTIME_API void  sf_call_action_subsys_disableCStates(SimStruct* S, void* execBlockPtr);
