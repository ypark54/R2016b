...
struct __slmsg_MemChunk_T
{
    ...
    unsigned long fBlockSize;     /* Chunk memory size */
    unsigned long fNumUnits;      /* Number of units of memory in block */
...
struct __slmsg_MemPool_T
{
    ...
    unsigned long fUnitSize;  /* Memory unit size */
    ...
    unsigned long fMemChunkSize; /* size of memchunk*/
...
struct _slMessage
{
    ...
    slMessage* fNext;
    slMessage* fPrev;
    slMsgMemPoolId fMsgPoolId;
    slMsgMemPoolId fDataPoolId;
    void *fAppData;
 ...
 */
typedef struct _slMsgManager 
{
    slMsgQueue *fQueues;
    slMsgDataSize fNumQueues;
    slMsgQueueId _scratchQueue;
...
SL_MESSAGES_EXPORT_FCN_C void __slmsg_Except_raise(__slmsg_Except_Type eType, const char *file, int line);
...
SL_MESSAGES_EXPORT_FCN_C void *__slmsg_Mem_alloc  (long nbytes, const char *file, int line);
SL_MESSAGES_EXPORT_FCN_C void *__slmsg_Mem_calloc (long count, long nbytes, const char *file, int line);
SL_MESSAGES_EXPORT_FCN_C void __slmsg_Mem_free    (void *ptr, const char *file, int line);
SL_MESSAGES_EXPORT_FCN_C void *__slmsg_Mem_resize (void *ptr, long nbytes, const char *file, int line);
